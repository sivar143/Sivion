...
@Component public class FinanceDispatchListener {
 private static final long TENANT=1L; private final InvoiceRepository invoices; public FinanceDispatchListener(InvoiceRepository invoices){this.invoices=invoices;}
